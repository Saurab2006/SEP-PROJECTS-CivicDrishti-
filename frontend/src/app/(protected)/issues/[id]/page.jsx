...
import {
  ...
  PlayCircle, Loader2, Star, Map as MapIcon, Radio, Plus, ShieldCheck, ShieldQuestion, ThumbsUp, MessageCircle, Send,
   Camera, RotateCcw, Languages, XCircle, ArrowRightLeft, Siren, ThumbsDown, Building2,
} from 'lucide-react';
...
export default function ReportDetailPage() {
  ...
  return (
    ...
    <div className="max-w-[900px] mx-auto space-y-5">
      ...
      {report.project && <LinkedProjectCard report={report} projectDetail={projectDetail} />}
...
function LinkedProjectCard({ report, projectDetail }) {
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm space-y-4">
