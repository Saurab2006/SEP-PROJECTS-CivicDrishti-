    ...
    <div className="mx-auto max-w-[1200px]">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4 border-b border-[#eae4d8] pb-6 dark:border-[#1e2636]">
        <div>
          ...
          <h1 className="mt-2 text-[28px] font-semibold tracking-tight text-[#102a2b] dark:text-[#f4f5f8]">{t('dashboard.pageTitle')}</h1>
        ...
        <button
          ...
          className="flex shrink-0 items-center gap-1 rounded-full border border-[#eae4d8] bg-white p-1 text-xs font-semibold dark:border-[#232c40] dark:bg-[#111a2c]"
        >
      ...
      {/* Headline numbers */}
      <div className="mt-8">
        <h2 className="text-lg font-semibold text-[#102a2b] dark:text-[#f4f5f8]">{t('dashboard.headlineTitle')}</h2>
        ...
        <div className="mt-4 grid grid-cols-2 gap-4 lg:grid-cols-4">
          {kpis.map((c) => (
            <div key={c.label} className="rounded-lg border border-[#eae4d8] bg-white p-5 dark:border-[#1e2636] dark:bg-[#111a2c]">
              <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-[#a39d8d] dark:text-[#6b7690]">{c.label}</p>
              {c.value === null ? <Skeleton className="mt-2 h-7 w-24" /> : <p className="mt-2 text-2xl font-semibold tracking-tight text-[#102a2b] dark:text-[#f4f5f8]">{c.value}</p>}
      ...
      {/* Trend charts */}
      <div className="mt-10">
        <h2 className="text-lg font-semibold text-[#102a2b] dark:text-[#f4f5f8]">{t('dashboard.trendTitle')}</h2>
        ...
        <div className="mt-4 grid gap-4 lg:grid-cols-2">
          <div className="rounded-lg border border-[#eae4d8] bg-white p-5 dark:border-[#1e2636] dark:bg-[#111a2c]">
            <p className="text-sm font-semibold text-[#102a2b] dark:text-[#f4f5f8]">{t('dashboard.budgetPanelTitle')}</p>
          ...
          <div className="rounded-lg border border-[#eae4d8] bg-white p-5 dark:border-[#1e2636] dark:bg-[#111a2c]">
            <p className="text-sm font-semibold text-[#102a2b] dark:text-[#f4f5f8]">{t('dashboard.deptPanelTitle')}</p>
      ...
      <div className="mt-10 mb-10">
        <h2 className="text-lg font-semibold text-[#102a2b] dark:text-[#f4f5f8]">{t('dashboard.reportsTitle')}</h2>
        ...
        <div className="mt-4 overflow-hidden rounded-lg border border-[#eae4d8] bg-white dark:border-[#1e2636] dark:bg-[#111a2c]">
          <div className="border-b border-[#eae4d8] px-5 py-4 dark:border-[#1e2636]">
            <p className="text-sm font-semibold text-[#102a2b] dark:text-[#f4f5f8]">{t('dashboard.latestReports')}</p>
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center px-6 py-14 text-center">
              <p className="text-sm font-semibold text-[#102a2b] dark:text-[#f4f5f8]">{t('dashboard.noReports')}</p>
              <p className="mt-1 max-w-[32ch] text-xs text-[#a39d8d] dark:text-[#6b7690]">{t('dashboard.noReportsSub')}</p>
              <Link href="/issues" className="mt-4 rounded-md bg-[#102a2b] px-3.5 py-2 text-xs font-semibold text-white hover:bg-[#0c2021] dark:bg-[#e7e9ee] dark:text-[#0b1220] dark:hover:bg-white">
