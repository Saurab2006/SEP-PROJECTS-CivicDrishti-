...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-[#faf9f6] text-[#25221f] dark:bg-[#0b1220] dark:text-[#e7e9ee]">
      ...
      <footer className="bg-[#bcc8d5] text-[#17212b]"><div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-10 md:flex-row md:items-center md:justify-between md:px-8"><CivicLogo /><div><p className="text-sm font-semibold text-[#17212b]">तपाईंको सरकार, तपाईंको दृष्टिमा</p><p className="mt-1 text-sm font-semibold text-[#263442]/80">Making reports, budgets, and public work accountable in every ward.</p></div></div></footer>
    </main>
  );
}