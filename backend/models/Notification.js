...
const notificationSchema = new mongoose.Schema({
  ...
  type:    { type: String, required: true, enum: ['new-report', 'assigned', 'eta-updated', 'verified', 'completed', 'flagged-fake', 'duplicate', 'comment', 'budget-flagged', 'important-notice', 'reopened', 'ward-issue', 'ward-community-issue', 'issue-supported', 'priority-escalated', 'municipality-escalation'] },
